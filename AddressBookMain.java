...
public class AddressBookMain {
	...
	public static void sortByOption() {
		...
		switch (choice) {
		case 1:
			AddressBookMain.sortBy(Contact::getFirstName).forEach(System.out::println);
			break;
		case 2:
			AddressBookMain.sortBy(Contact::getLastName).forEach(System.out::println);
			break;
		case 3:
			AddressBookMain.sortBy(Contact::getCity).forEach(System.out::println);
			break;
		case 4:
			AddressBookMain.sortBy(Contact::getState).forEach(System.out::println);
			break;
		case 5:
			AddressBookMain.sortByZip(Contact::getZipCode).forEach(System.out::println);
			break;
		default:
			System.out.println("Please enter a valid choice");
		}
